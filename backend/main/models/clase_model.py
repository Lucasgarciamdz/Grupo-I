...
class Clase(db.Model):
    ...
    def from_json(clase_json):
        ...
        descripcion = clase_json.get("descripcion")  # use get method
        imagen = clase_json.get("imagen")  # use get method
        return Clase(
            id_clase=id_clase, tipo=tipo, descripcion=descripcion, imagen=imagen
        )
